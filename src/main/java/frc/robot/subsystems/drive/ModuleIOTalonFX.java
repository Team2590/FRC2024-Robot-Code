  ...
  public ModuleIOTalonFX(int index) {
    switch (index) {
      case 0: // Front Left
        ...
        absoluteEncoderOffset = new Rotation2d(-1.806); // MUST BE CALIBRATED
        break;
      case 1: // Front Right
        driveTalon = new TalonFX(13);
        turnTalon = new TalonFX(11);
        cancoder = new CANcoder(12);
        absoluteEncoderOffset = new Rotation2d(-2.854); // MUST BE CALIBRATED
        break;
      case 2: // Back Left
        driveTalon = new TalonFX(33);
        turnTalon = new TalonFX(31);
        cancoder = new CANcoder(32);
        absoluteEncoderOffset = new Rotation2d(-2.831); // MUST BE CALIBRATED
        break;
      case 3: // Back Right
        driveTalon = new TalonFX(23);
        turnTalon = new TalonFX(21);
        cancoder = new CANcoder(22);
        absoluteEncoderOffset = new Rotation2d(-1.818); // MUST BE CALIBRATED
        break;
      default:
