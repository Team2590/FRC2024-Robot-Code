...
public class Drive extends SubsystemBase {
  private static final double MAX_LINEAR_SPEED = Units.feetToMeters(14.5); // originally 14
  ...
  private static final double DRIVE_BASE_RADIUS = Units.inchesToMeters(18.75); //measured from cad
