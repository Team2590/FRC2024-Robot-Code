...
public class ArmIOSim implements ArmIO {
  ...
  private final DCMotorSim armSim =
      new DCMotorSim(DCMotor.getFalcon500(1), ArmConstants.ARM_GEAR_RATIO, 1.0);
  ...
  public void updateInputs(ArmIOInputs inputs) {
    ...
    // TODO: in ArmIOTalonFX, this value is in rotations per second. the sim version of this value
    // should be verified
