...
public class AutoRoutines {
  ...
  public static final LoggedDashboardChooser<Command> buildChooser(
    ...
    // autoChooser.addOption("2_startB_n2", ezAuto.apply("startB", SHOOT, "startB_note2",
    // SNAP_SHOOT));
    // autoChooser.addOption(
    //     "3_startA_n1_n4",
    //     ezAuto.apply(
    ...
    autoChooser.addOption(
        ...
        ezAuto.apply(
            ...
            SNAP_SHOOT));
    autoChooser.addOption(
        "4_SPLIT_startA_shoot_first_n4_n5_n6",
        ezAuto.apply(
            "startA",
            SNAP_SHOOT,
            "startA_out",
