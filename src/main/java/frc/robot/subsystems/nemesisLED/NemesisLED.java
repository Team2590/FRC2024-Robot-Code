...
/**
 * Controls the LEDs. 
 * States: OFF, SOLID, FLASH (between white and other), ALTERNATE, CYCLE, NEMESIS, and CELEBRATE
 * 
 * @author Jeevan Sailesh, Elan Ronen, Shashank Madala
 * 
 * @see <a href="https://docs.wpilib.org/en/stable/docs/software/hardware-apis/misc/addressable-leds.html">WPILIB LED Tutorial</a>
 */
public class NemesisLED extends SubsystemBase {
    ...
    public static NemesisLED getInstance() {
        return instance == null ? instance = new NemesisLED(LEDConstants.LED_PORT, LEDConstants.BUFFER_LENGTH) : instance;
    }
    ...
    private enum States {
        OFF, SOLID, FLASH, ALTERNATE, CYCLE, NEMESIS, CELEBRATE, INTAKE, HAS_NOTE, SCORE_AMP, IDLE, DISABLED,
    }
    ...
    //  * Each color is shown for {@link frc.settings.LEDsettings#FLASH_INTERVAL FLASH_INTERVAL} milliseconds.
    //  * @param r - red RGB value
    //  * @param g - green RGB value
    //  * @param b - blue RGB value
    //  */
    ...
    public void flash(int r, int g, int b) {
        if (timer >= 2 * LEDConstants.FLASH_INTERVAL){timer = 0;}
